...
execute as @e[tag=SpiderBomb] at @s run summon minecraft:cave_spider ~ ~ ~ {Health:35f,Tags:["SpiderMob"],CustomName:"{\"text\":\"Mutated Spider\",\"color\":\"green\"}",HandItems:[{id:"minecraft:diamond_sword",Count:1b,tag:{HideFlags:1,Enchantments:[{id:"minecraft:sharpness",lvl:10s}]}},{}],HandDropChances:[-327.67F,0.85F],ActiveEffects:[{Id:1b,Amplifier:1b,Duration:6000,ShowParticles:0b}],Attributes:[{Name:generic.maxHealth,Base:50}]}
